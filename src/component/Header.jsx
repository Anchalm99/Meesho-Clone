...
const Header = () => {
  ...
  function changehandler(e){
    ...
    const filteredData = ittem.data.filter(item => {
      const titleMatches = item.title.toLowerCase().includes(searchText);
      const descriptionMatches = item.description.toLowerCase().includes(searchText);
      return titleMatches || descriptionMatches;
    });

    ittem.updateapidata(filteredData);
  }
